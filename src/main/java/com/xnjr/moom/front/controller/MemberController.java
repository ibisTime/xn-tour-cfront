...
public class MemberController extends BaseController {
    ...
    public Object doRegister(
        ...
        return userAO.doRegister(mobile, loginPwd, userReferee, smsCaptcha, companyCode);
    }
    ...
    public Object doLogin(@RequestParam("loginName") String loginName,
            @RequestParam("loginPwd") String loginPwd) {
        Map res = userAO.doLogin(loginName, loginPwd);
//        Map res1 = userAO.doGetUser((String)res.get("userId"));
    ...
    public Object queryAddresses(
        ...
        return userAO.queryAddresses(code, this.getSessionUser().getUserId(), isDefault);
    }
