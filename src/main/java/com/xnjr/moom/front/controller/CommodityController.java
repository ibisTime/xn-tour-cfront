...
public class CommodityController extends BaseController {
	...
	public Object queryListProducts(
		...
		return commodityAO.queryListProducts(category, type, name, status,
				companyCode);
	}
	...
	@ResponseBody
	public Object queryPageCategory(
			...
			@RequestParam(value = "orderColumn", required = false) String orderColumn,
			@RequestParam(value = "orderDir", required = false) String orderDir) {
		return commodityAO.queryPageCategory(parentCode, name, companyCode,
				type, start, limit, orderColumn, orderDir);
	}
