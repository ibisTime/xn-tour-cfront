...
public class OperatorAOImpl implements IOperatorAO {
	...
	public Object payOrder(String code, String userId) {
		return BizConnecter.getBizData("808052",
	...
	public Object queryOrder(String invoiceCode) {
		return BizConnecter.getBizData("808072",
				JsonUtils.string2Json("code", invoiceCode), Object.class);
	}

	public Object queryOrders(String applyUser, String status, String mobile,
			String companyCode) {
	...
	public Object submitCart(String receiver, String reMobile,
			...
			String receiptType, String receiptTitle, List<String> cartCodeList) {
	...
	@Override
	public Object xpeditePurchase(String code) {
		return BizConnecter.getBizData("808058",
				JsonUtils.string2Json("code", code), Object.class);
	}
}
