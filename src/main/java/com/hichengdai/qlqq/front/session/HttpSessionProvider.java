...
public class HttpSessionProvider implements ISessionProvider {
    ...
    /** 
     * @see com.xnjr.account.front.json.ISessionProvider.ihoms.web.core.session.hsnet.core.session.SessionProvider#setUserDetail(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse, com.hichengdai.qlqq.front.session.AUserDetail.ihoms.web.core.session.hsnet.core.session.UserDetail)
     */
    @Override
