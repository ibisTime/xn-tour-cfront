define([
	...
	return declare([TextBox], {
		...
		_setValidatesAttr: function(value) {
			var cv = [{
				pattern: /^[\s0-9a-zA-Z\u4e00-\u9fa5\u00d7\u300a\u2014\u2018\u2019\u201c\u201d\u2026\u3001\u3002\u300b\u300e\u300f\u3010\u3011\uff01\uff08\uff09\uff0c\uff1a\uff1b\uff1f\uff0d\uff03\uffe5\x21-\x7e]*$/,
				message: '请输入合法字符'
			}];
			this._set('validates', cv.concat(value));
        ...
        switchPasswordLevel: function(level) {
            ...
            switch(level) {
                case 0:
                    ...
                    domClass.remove(levelEl, 'genericProgressBarNormal');
                ...
                case 1:
                    ...
                    break;
                case 2:
                    domClass.add(levelEl, 'genericProgressBarNormal');
                    domClass.remove(levelEl, 'genericProgressBarBad');
                    domClass.remove(levelEl, 'genericProgressBarGreat');
                    domStyle.set(levelEl, {
                        width: '66%'
		...
		_setUnitAttr: function(value) {
			...
			if (value) {
				domConstruct.create('span', {className: 'ui-label-extra',
					style: 'left: 170px;height: 50%;margin: auto;top:0;bottom:0;', // fix the position, but not recommend
...
//		},
		...
		addError: function(value, msg) {
			this.errorValues[value] = msg;
			this.checkValidity();
		},
		...
		validator: function(/*anything*/ value, /*__Constraints*/ constraints){
			...
			// tags:
			//		protected
			if (value in this.errorValues) {
				this.set('message', this.errorValues[value]);
				return false;
			}
