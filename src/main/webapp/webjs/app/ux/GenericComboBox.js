...
//				});
		...
		_setItemAttr: function(/*item*/ item, /*Boolean?*/ priorityChange, /*String?*/ displayedValue){
			...
			if(item){
				...
				//}
				if(!displayedValue){
					displayedValue = item[this.labelAttr] || this.store.getValue(item, this.searchAttr) ;
				}
				var value = item[this.searchAttr] || (this._getValueField() != this.searchAttr ? this.store.getIdentity(item) :
