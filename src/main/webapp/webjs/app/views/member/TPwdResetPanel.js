define([
    ...
    'app/common/Date',
    'dojo/text!./templates/TPwdResetPanel.html'
], function (declare, _WidgetBase, _TemplatedMixin, ViewMixin, on, query,
             domClass, domStyle, Global, DisplayBox, TextBox, PhoneCodeBox, Button, DateUtil, template) {
    return declare([_WidgetBase, _TemplatedMixin, ViewMixin], {
        ...
        isValid: function() {
            return this.IDNoFld.checkValidity() && this.phoneCodeFld.checkValidity() &&
