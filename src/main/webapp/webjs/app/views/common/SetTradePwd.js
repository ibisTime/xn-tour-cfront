define("app/views/common/SetTradePwd", [
    'dojo/_base/declare',
    'dijit/_WidgetBase', 
    ...
    'dojo/when',
    'app/common/Data',
    'dojo/text!./templates/SetTradePwd.html',
    'app/jquery/$'
    ...
    return declare([_WidgetBase, _TemplatedMixin, ViewMixin], {
        ...
        render: function() {
            ...
            function handleSendVerifiy() {
                ...
                Ajax.post(Global.baseUrl + '/gene/settradepwd/send',
                    {
            ...
            function doSuccess(){
                $(".register_title h4").text("交易密码设置成功");
                ...
                $(".register_content form").html('<div class="tupian"></div>' +
                    '<div class="wenzi">恭喜您，交易密码设置成功！</div>' +
            ...
            function setTradePwd(){
                if(validate()){
                    ...
                    $(me.nextAction).css("cursor", "default").text("设置中...");
                    var param = {
                        "tradePwd": me.password.value,
                        "smsCaptcha": me.verification.value
                    };
                    Ajax.post(Global.baseUrl + '/user/tradepwd/set', param)
                        .then(function (response) {
                            if (response.success) {
                                doSuccess();
                            } else {
