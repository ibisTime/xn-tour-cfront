define("app/views/common/BankcardSelectionField", [
    'dojo/_base/declare',
    'dijit/_WidgetBase', 
...
], function (declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, ViewMixin, Global, on, mouse,
		...
		_setBanksAttr: function(value) {
			...
			for (; i <len; i++) {
				var html = '<li class="list-chooseBank-item" style="position: relative;">' +
					...
					'<img src="'+value[i].url1+'" width="110" height="25"></a></li>';
